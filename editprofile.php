...
<!-- The rest of your HTML code remains unchanged -->
        ...
        <div class="container text-center">
            <div class="row">
                ...
                <a href="main-page-client.php?id=<?php echo $id ?>"><button type="button" class="btn btn-warning freelancer-mode-btn mt-3" style="margin-left: 0px;">Freelancer Mode</button></a><br>
                <a href="login-page.php"><button type="button" class="btn btn-danger freelancer-mode-btn mt-3" >Sign-out </button></a><br>
            </div>
            </div>
                <div class="col-md-6">
                ...
                <br>
                <p>Welcome to WorkWave, where talent meets opportunity! At WorkWave, we're on a mission to revolutionize the way individuals and businesses connect and collaborate. Our platform is designed to empower freelancers and businesses alike, providing a dynamic marketplace where skills are matched with projects, and creativity knows no bounds.
            Our Vision
            WorkWave envisions a world where every skill finds its perfect match and where businesses seamlessly connect with the right talent to achieve their goals. We believe in fostering a global community of freelancers and clients who collaborate, innovate, and succeed together.</p>
                </div></div>
            </div>
            </div>
    ...
    <div class="modal-footer">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                    <form action="edit-profile.php" method="post" id="myform" enctype="multipart/form-data">
    <!-- ... other form elements ... -->
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Username:</label>
                            <input type="text" class="form-control" id="username" name="newUsername">
                        </div>
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Bio:</label>
                            <input type="text" class="form-control" id="bio" name="newBio">
                        </div>
                        <!-- ... other form elements ... -->
                        <button type="submit" class="btn btn-primary" name="editButton">Save Changes</button>
                    </form>
